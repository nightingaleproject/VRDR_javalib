...
public class TobaccoUseContributedToDeathUtil {
	...
	public static final CodeableConcept VALUE_PROBABLECODE = new CodeableConcept().addCoding(new Coding().setCode("2931005").setSystem(CommonUtil.snomedSystemUrl).setDisplay("Probably"));
