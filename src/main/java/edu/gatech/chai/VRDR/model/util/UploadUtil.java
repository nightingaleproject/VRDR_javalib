...
public class UploadUtil {
    ...
    /// <summary>Create the payload for submission to the NVSS FHIR API for bulk
    /// upload</summary>
    public static String CreateBulkUploadPayload(VRDRFhirContext ctx, List<BaseMessage> messages, String url,
            boolean prettyPrint) {
