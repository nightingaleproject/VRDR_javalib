...
import edu.gatech.chai.VRDR.model.valueset.AdministrativeGenderVS;
import edu.gatech.chai.VRDR.model.valueset.MaritalStatusVS;
...
public class DecedentUtil {
	...
	public static final String bypassEditFlagExtensionURL = "http://hl7.org/fhir/us/vrdr/StructureDefinition/BypassEditFlag";
	...
	public static final CodeableConcept identifierTypeFixedValue = new CodeableConcept()
			.addCoding(new Coding().setSystem(CommonUtil.identifierTypeHL7System).setCode("SB")
	...
	public static final HashSet<CodeableConcept> maritalStatusSet = MaritalStatusVS.valueSet;
	...
	public static Set<CodeableConcept> sexAtDeathSet = AdministrativeGenderVS.valueSet;
