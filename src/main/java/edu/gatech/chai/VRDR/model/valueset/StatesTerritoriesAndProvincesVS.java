...
public class StatesTerritoriesAndProvincesVS {
    public static final String url = "http://hl7.org/fhir/us/vrdr/ValueSet/vrdr-states-territories-provinces-vs";
    public static final HashSet<CodeableConcept> valueSet = new HashSet<>(Arrays.asList(
        ...
        new CodeableConcept().addCoding(new Coding("http://terminology.hl7.org/CodeSystem/v3-NullFlavor","UNK","None"))
    ));
};